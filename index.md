  ...
  <main>
    <div class="relative pt-16 pb-32 flex content-center items-center justify-center" style="min-height: 75vh;">
      ...
      <div
        ...
        style= "background: url(https://images.unsplash.com/photo-1464851707681-f9d5fdaccea8?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2605&q=80)">
        <!-- Overlay -->
...
<script>
  AOS.init({ 
    ...
    duration: 1500, // values from 0 to 3000, with steps 50ms
    once: false, // whether animation should happen only once while scrolling past them
    mirror: false,
  });
</script>
<!-- Navigation Script -->
